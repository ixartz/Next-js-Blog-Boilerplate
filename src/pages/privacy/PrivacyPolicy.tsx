...
const PrivacyPolicy = () => (
  <Main
    meta={
      <Meta
        title="Privacy Policy | Marble Expert"
        description={AppConfig.description}
      />
    }
  >
    <div className="flex justify-center">
      <div className="page prose prose-slate">
        <div className="header">
          <div className="container">
            <p className="title">Privacy Policy for Marble Expert</p>
          </div>
        </div>
        <div className="translations-content-container">
          <div className="container">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Marble Expert.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Marble Expert, accessible
                    from{' '}
                    <a
                      href="https://www.marble-expert.com"
              ...
              <ul>
                <li>
                  <p>By email: {'db191996@gmail.com'}</p>
                </li>
                <li>
                  <p>By phone number: +250781257984</p>
                </li>
              </ul>
            </div>
          </div>
